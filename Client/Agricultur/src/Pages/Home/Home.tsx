...
const Home: React.FC = () => {
    ...
    <div id='Home' className='flex items-center justify-center h-screen'>
        <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" className='w-5/12' >
            <img src={HomeImage} alt="" />
        </div>
        <div data-aos="fade-left" data-aos-easing="linear" data-aos-duration="1500" className='flex flex-col items-center justify-center w-7/12'>
